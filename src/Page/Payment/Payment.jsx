...
const Payment = ({ data, res }) => {
  ...
  return (
    <div>
      <button
        onClick={showModal}
        className="bg-red-400 text-white py-1.5 px-3 rounded-full min-w-[150px] hover:bg-red-300"
      >
        Register
      </button>
      <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        <PayPalScriptProvider
          options={{
            "client-id":
              "AVpBPKvvEYVcWq7GDrnxKyYHgBT2RApnp95Mwoupc-jJE1lcZ-OayBq_ktkzihL8nWxVOFFj4_eC3HAC",
          }}
        >
