  ...
  return (
    <div className="text-left">
      <div className="flex justify-between">
        <p className="my-4 text-gray-400 font-medium">Contact Information</p>
        <button onClick={toggleButtonEdit}>
          {profileContext.isEdit ? (
        ...
        <div className="w-8/12 ml-4">
          {profileContext.isEdit ? (
            <input
              ...
              value={profileContext?.dataProfile?.fullname}
              className="w-full"
            />
          ) : (
            <p className="m-0 text-blue-600">
              {profileContext?.dataProfile?.fullname}
            </p>
          )}
        </div>
      </div>
        ...
        <div className="w-8/12 ml-4">
          {profileContext.isEdit ? (
            <input
              ...
              type="text"
              onChange={handleChangeField}
              value={profileContext?.dataProfile?.phone}
              className="w-full"
            />
          ) : (
            <p className="m-0 text-blue-600">
              {profileContext?.dataProfile?.phone}
            </p>
          )}
        </div>
      </div>
        ...
        <div className="w-8/12 ml-4">
          {profileContext.isEdit ? (
            <input
              ...
              type="text"
              onChange={handleChangeField}
              value={profileContext?.dataProfile?.address}
              className="w-full"
            />
          ) : (
      ...
      <div className="flex mb-2.5 input-wrapper">
        ...
        <div className="w-8/12 ml-4">
          <p className="m-0 text-blue-600">
            {profileContext?.dataProfile?.email}
          </p>
        </div>
      </div>

      <div>
        <p className="my-4 text-gray-400 font-medium">Basic Information</p>
        <div>
          <div className="flex mb-2.5 input-wrapper">
            <div className="w-2/12">
          ...
          <div className="flex mb-2.5 input-wrapper">
            ...
            <div className="w-8/12 ml-4">
              {profileContext.isEdit ? (
                ...
                <p className="m-0">
                  {profileContext?.dataProfile?.gender === 1
                    ? "Male"
                    : "Female"}
                </p>
              )}
      ...
      {profileContext.isEdit && (
        <div className="flex justify-end items-center">
          <button
            className="btn-custom my-btn px-4 py-2"
